...
describe('CustomersService', () => {
  ...
  it('should Get customers from DB', () => {
    ...
    const req = httpMock.expectOne(API_ROUTES.GET_USERS);
  ...
  it('should GetSingle customer from DB', () => {
    ...
    const req = httpMock.expectOne(API_ROUTES.GET_USER_BY_ID(1));
    req.flush(dummyCustomers);
    expect(req.request.method).toBe('GET');
  });
  ...
  it('should Add customer To DB', () => {
    ...
    const req = httpMock.expectOne(API_ROUTES.CREATE_USER);
    req.flush(dummyCustomers);
  ...
  it('should Delete customer from DB', () => {
    ...
    const req = httpMock.expectOne(API_ROUTES.DELETE_USER_BY_ID(1));
    req.flush(dummyCustomers);
  ...
  it('should Update customer in DB', () => {
    ...
    const req = httpMock.expectOne(API_ROUTES.UPDATE_USER);
    req.flush(dummyCustomers);
